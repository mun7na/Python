...
def mail():
    ...
    msg = message("Good!", "Hi there!",
                  r"C:\Users\Excel Engine\Downloads\th.jfif",
                  r"C:\Users\Excel Engine\Downloads\sample3.py")

    # Make a list of emails, where you wanna send mail
    to = ["munna7.pen@gmail.com",
          "XYZ@gmail.com", "insaaf@gmail.com"]

    # Provide some data to the sendmail function!
    smtp.sendmail(from_addr="munna75757575@gmail.com",
