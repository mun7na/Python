...
import csv
# open file by passing the file path.C:\Users\Excel Engine\Documents
with open(r'C:\Users\Excel Engine\Downloads\annual-enterprise-survey-2023-financial-year-provisional.csv') as csv_file:
